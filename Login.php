                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            if($role == 'Recruiter'){
                                header("location: recruiter/recruiterHome.php");
                            } else {
                                header("location: homePage.php");
                            }
...
<head>
    <meta charset="UTF-8">
    <title>GradHunt: Login</title>
    <link rel = "icon" href ="title-icon.png" type = "image/x-icon">
...
<div class="wrapper">
    <img src="recruiter/images/logo.png" alt="recruiter/images/logo2.png" style='height: 100%; width: 100%; object-fit: contain'>

    <h2>.</h2>
    <p>Please fill in your login credentials to login.</p>
